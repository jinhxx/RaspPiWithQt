    ...
    , ui(new Ui::widget)
{
    ...
    connect(ui->tempButton, &QPushButton::clicked, this, &widget::display_temp);
    connect(ui->humiButton, &QPushButton::clicked, this, &widget::display_humi);
}
...
void widget::display_temp()
{
    float temp = sht20->measureTemp();
    qDebug("Temp : %.2f", temp);
    ui->lcdNumber_1->display(temp);
}

void widget::display_humi()
{
    float humi = sht20->measureHumi();
    qDebug("Humi :%.2f", humi);
...
//{
//    if(flag == HIGH)
//        ui->label_SW_PIC1->setEnabled(true);
//    else
//        ui->label_SW_PIC1->setEnabled(false);
//}

//void widget::Toggle_LED2(int flag)
//{
//    if(flag == HIGH)
//        ui->label_SW_PIC2->setEnabled(true);
//    else
//        ui->label_SW_PIC2->setEnabled(false);
//}

//void widget::Toggle_LED3(int flag)
//{
//    if(flag == HIGH)
//        ui->label_SW_PIC3->setEnabled(true);
//    else
//        ui->label_SW_PIC3->setEnabled(false);
//}

//void widget::Toggle_LED4(int flag)
//{
//    if(flag == HIGH)
//        ui->label_SW_PIC4->setEnabled(true);
//    else
//        ui->label_SW_PIC4->setEnabled(false);
//}
